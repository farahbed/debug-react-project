        ...
        <section className='ServicesContainer' id='nos-services'>
          ...
          <div className='ListContainer'>
            ...
            <ServiceCard imageSrc='/images/hall-expo.png'>
              ...
              soit sa taille, en s’adaptant à vos demandes. En tant que spécialistes 
              de l’évènementiel, nous saurons trouver le lieu parfait ainsi que des 
              solutions inédites pour capter votre audience et faire de cet évènement un succès.
            </ServiceCard>
            <ServiceCard imageSrc='/images/sophia-sideri-LFXMtUuAKK8-unsplash1.png'>
              ...
              de la réalité augmentée et de la réalité mixte, à la veille technologique 
      ...
      <footer className='row'>
        ...
        <div className='col description'>
          ...
          <p>
            ...
            tels que des événements festifs, des manifestations sportives et culturelles, 
            ainsi que des événements professionnels.
          </p>
        </div>
      </footer>
    </>
